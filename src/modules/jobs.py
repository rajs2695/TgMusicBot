...
class InactiveCallManager:
    ...
    async def end_inactive_calls(self):
        ...
        for i in range(0, len(tasks), 86400):
            await asyncio.gather(*tasks[i : i + 86400])
    ...
    async def start_scheduler(self):
        ...
        self.scheduler.add_job(self.end_inactive_calls, "interval", seconds=86400)
